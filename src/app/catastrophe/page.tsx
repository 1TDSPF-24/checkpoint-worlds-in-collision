    ...
    return (
        <section className="flex flex-col items-center p-8 gap-12 bg-slate-900 text-white">
            ...
            <div className="flex items-center justify-center px-8 py-4 gap-6 max-w-4xl">
                ...
                <Image src={Comet} alt="Imannuel Velikovsky" width={1000} height={1000} className="size-72 rounded-xl" />
            </div>
            <div className="flex items-center justify-center px-8 py-4 gap-6 max-w-4xl">
                <Image src={Bible} alt="Sistema Solar" width={800} height={800} className="size-72 rounded-2xl" />
